...
(function () {
    ...
    function startGame() {
        ...
        cardList = [];
        let currentStars = `<li><i class='fa fa-star'></i></li>`;
        document.querySelector('.stars').innerHTML = currentStars.repeat(3);
    ...
    function starRating() {
        ...
        if (moveCount === 12) {
            document.querySelector('.stars').innerHTML = currentStars.repeat(2);
